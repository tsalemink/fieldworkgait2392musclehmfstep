...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def validate(self):
        ...
        id_value = self.identifierOccursCount(self._ui.lineEdit0.text())
        id_valid = (id_value == 0) or (id_value == 1 and self._previousIdentifier == self._ui.lineEdit0.text())
        self._ui.lineEdit0.setStyleSheet(DEFAULT_STYLE_SHEET if id_valid else INVALID_STYLE_SHEET)
