...
#
# Created: Sat Apr 23 23:09:30 2016
...
class Ui_ConfigureDialog(object):
    def setupUi(self, ConfigureDialog):
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.label5)
        self.comboBox_side = QtGui.QComboBox(self.configGroupBox)
        self.comboBox_side.setObjectName("comboBox_side")
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.comboBox_side)
        ...
        ConfigureDialog.setTabOrder(self.comboBox_out_unit, self.comboBox_side)
        ConfigureDialog.setTabOrder(self.comboBox_side, self.checkBox_write_osim_file)
    ...
    def retranslateUi(self, ConfigureDialog):
        ...
        self.label5.setText(QtGui.QApplication.translate("ConfigureDialog", "Side:  ", None, QtGui.QApplication.UnicodeUTF8))
